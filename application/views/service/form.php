<div class="bg-white shadow-sm p-3 bg-body rounded box-service" style="margin-bottom: 250px;">
	...
	<h4 class="tittle-service">SERVICE</h4>
		<form action="<?php echo base_url(). 'service/service/tambah_data' ?>" enctype="multipart/form-data" method="post">
			...
			<div class="form-group" align="right">
				<button type="submit" class="col-auto btn btn-primary mx-auto mt-4 mb-5">Service</button>
			</div>
		</form>
	</div>
</div>