...
class Invoice extends CI_Controller{
	...
	public function index(){
		...
		$this->load->view('owner/menu/invoice/list_invoice', $data);
	...
	public function detail($id_invoice){
		...
		$this->load->view('owner/templates/header');
		$this->load->view('owner/menu/invoice/detail_invoice', $data);
		$this->load->view('owner/templates/footer');
	}
	...
	public function edit($id){
		...
		$this->load->view('owner/templates/sidebar');
		$this->load->view('owner/templates/navbar');
		$this->load->view('owner/menu/invoice/edit_invoice', $data);
		$this->load->view('owner/templates/footer');
	}
